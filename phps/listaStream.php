	<?php
						...
						$stream_list="egstephano,followgrubby,weedamins,mlgsc2,liquidsnute,rootcatz,hellosase,dragon";
						$stream_name=array("EGStephano"=>"egstephano","FollowGrubby"=>"followgrubby","Weedamins"=>"weedamins","MLG"=>"mlgsc2","Liquid Snute"=>"liquidsnute","ROOT Catz"=>"rootcatz","SaSe"=>"hellosase","Dragon"=>"dragon");
